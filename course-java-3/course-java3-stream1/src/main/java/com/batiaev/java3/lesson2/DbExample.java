...
public class DbExample {
    private static final String DB_PATH = "/Users/anton/Documents/_repo/_github/batiaev/courses/course-java-3/stream1/resorses/lesson2.db";
...
//            conn.setAutoCommit();
            ...
            result = stmt.executeUpdate("UPDATE Students SET Name = 'Bob1' WHERE Name = 'Bob'");
            System.out.println(result);
