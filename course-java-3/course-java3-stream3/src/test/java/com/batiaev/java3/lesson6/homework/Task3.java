...
public class Task3 {
    ...
    public void testTask2AnotherDigits() {
        assertTrue("В массиве есть другие цифры",
                Homework6.task3(new int[]{1, 1, 4, 1, 4, 1, 4, 4, 4, 1}));
    ...
    public void testTask2LongWait() {
        ...
        Assert.assertFalse("Ошибка", Homework6.task3(data));
    }

    @Test
    public void testTask2Contain1() {
        Assert.assertFalse("В массиве есть 1", Homework6.task3(new int[]{4, 4, 4, 4, 4}));
        log.info("Массив только из 4");
    }

    @Test
    public void testTask2Contain4() {
        Assert.assertFalse("В массиве есть 4", Homework6.task3(new int[]{1, 1, 1}));
